## Hi there 👋
## Im MICHAEL NGAMAU ,welcome to my Dev space with all my ideas,builds and work.

**Full-Stack Developer** — Building digital experiences that matter.

I create clean, scalable, and user-friendly web applications that solve real problems and deliver exceptional user experiences. I love turning ideas into robust applications—from front-end interfaces to APIs and databases—using modern tools and best practices. I build and share projects on GitHub, from full-stack apps to open-source contributions.
...
*[View my GitHub repositories](https://github.com/donamiri?tab=repositories)*
